...
- (void)drawRect:(CGRect)rect {
    UIImage *norImage = [UIImage imageNamed:BackgroundStarImage];
    UIImage *selImage = [UIImage imageNamed:ForegroundStarImage];
    // 图片没间隙自己画
