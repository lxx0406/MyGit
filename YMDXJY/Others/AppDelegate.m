...
@interface AppDelegate ()<UNUserNotificationCenterDelegate, UITabBarControllerDelegate, CYLTabBarControllerDelegate>
...
- (void)setUpNavigationBarAppearance {
    ...
    [[UINavigationBar appearance] setBarTintColor:YYNavBarColor];
...
- (void)loadMainVC{
    ...
    PHTabBarcontrollerConfig *tabBarControllerConfig = [[PHTabBarcontrollerConfig alloc] init];
